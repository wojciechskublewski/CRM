...
<div class="container">
    ...
    <form:form method="post" modelAttribute="project">
        <div class="form-group row">
            ...
            <div class="col-sm-7">
                <form:input path="name" value="${project.name}" class="form-control" id="nameID" />
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-7">
                <form:textarea value="${project.description}" path="description" class="form-control" id="desID" />
            </div>
        </div>
